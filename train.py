...
def setup_training_options(
    ...
    augpipe_specs = {
        ...
        'custom':   dict(xint=1, scale=1, rotate=1, aniso=1, xfrac=1, brightness=1, contrast=1, saturation=1, imgfilter=1, noise=1, cutout=1),
...
def main():
    ...
    group.add_argument('--augpipe', help='Augmentation pipeline (default: bgc)', choices=['blit', 'geom', 'color', 'filter', 'noise', 'cutout', 'custom', 'bg', 'bgc', 'bgcf', 'bgcfn', 'bgcfnc'])
